...
public class MobileBankingPaymentView extends BorderPane {
    ...
    private VBox createContent() {
        ...
        Label instructions = new Label("Silahkan gunakan aplikasi mobile banking pilihan anda untuk menyelesaikan pembayaran.");
    ...
    private VBox createVirtualAccountBox() {
        ...
        vaBox.setStyle("-fx-background-color: #f9fafb; -fx-border-color: #EAECF0; -fx-border-width: 1; -fx-padding: 20; -fx-background-radius: 8; -fx-border-radius: 8;");
        
        HBox bankInfo = new HBox(10);
        bankInfo.setAlignment(Pos.CENTER_LEFT);
        
        Region icon = new Region();
        icon.setStyle("-fx-background-color: linear-gradient(to right, orange, pink); -fx-background-radius: 20; -fx-min-width: 40; -fx-min-height: 40;");
    ...
    private Button createConfirmButton() {
        ...
        confirmButton.setStyle("-fx-background-color: #9957B3; -fx-text-fill: white; -fx-font-weight: bold; -fx-font-size: 16; -fx-padding: 15 30; -fx-cursor: hand;");
